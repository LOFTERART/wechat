...
[![Author](https://img.shields.io/badge/Author-Jerry-blue.svg)](https://www.gopay.ink)
[![Build Status](https://travis-ci.org/cuckoopark/gopay.svg?branch=master)](https://travis-ci.org/cuckoopark/gopay)
[![Latest Tag](https://img.shields.io/github/tag/cuckoopark/gopay.svg)](https://github.com/cuckoopark/gopay/releases/latest)

# 安装

```shell
go get -u github.com/cuckoopark/gopay
```
