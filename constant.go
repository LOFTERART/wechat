...
const (
	...
	// BankType                 = "CQB_DEBIT"         // 重庆银行(借记卡)
	// BankType                 = "SDEB_DEBIT"        // 顺德农商行(借记卡)
	// BankType                 = "SZRCB_DEBIT"       // 深圳农商银行(借记卡)
	// BankType                 = "SZRCB_CREDIT"      // 深圳农商银行(信用卡)
	// BankType                 = "HRBB_DEBIT"        // 哈尔滨银行(借记卡)
	// BankType                 = "BOCD_DEBIT"        // 成都银行(借记卡)
	// BankType                 = "GDNYB_DEBIT"       // 南粤银行(借记卡)
	// BankType                 = "GDNYB_CREDIT"      // 南粤银行(信用卡)
	// BankType                 = "GZCB_DEBIT"        // 广州银行(借记卡)
	// BankType                 = "GZCB_CREDIT"       // 广州银行(信用卡)
	// BankType                 = "JSB_DEBIT"         // 江苏银行(借记卡)
	// BankType                 = "JSB_CREDIT"        // 江苏银行(信用卡)
	// BankType                 = "NBCB_DEBIT"        // 宁波银行(借记卡)
	// BankType                 = "NBCB_CREDIT"       // 宁波银行(信用卡)
	// BankType                 = "NJCB_DEBIT"        // 南京银行(借记卡)
	// BankType                 = "QHNX_DEBIT"        // 青海农信(借记卡)
	// BankType                 = "ORDOSB_CREDIT"     // 鄂尔多斯银行(信用卡)
	// BankType                 = "ORDOSB_DEBIT"      // 鄂尔多斯银行(借记卡)
	// BankType                 = "BJRCB_CREDIT"      // 北京农商(信用卡)
	// BankType                 = "BHB_DEBIT"         // 河北银行(借记卡)
	// BankType                 = "BGZB_DEBIT"        // 贵州银行(借记卡)
	// BankType                 = "BEEB_DEBIT"        // 鄞州银行(借记卡)
	// BankType                 = "PZHCCB_DEBIT"      // 攀枝花银行(借记卡)
	// BankType                 = "QDCCB_CREDIT"      // 青岛银行(信用卡)
	// BankType                 = "QDCCB_DEBIT"       // 青岛银行(借记卡)
	// BankType                 = "SHINHAN_DEBIT"     // 新韩银行(借记卡)
	// BankType                 = "QLB_DEBIT"         // 齐鲁银行(借记卡)
	// BankType                 = "QSB_DEBIT"         // 齐商银行(借记卡)
	// BankType                 = "ZZB_DEBIT"         // 郑州银行(借记卡)
	// BankType                 = "CCAB_DEBIT"        // 长安银行(借记卡)
	// BankType                 = "RZB_DEBIT"         // 日照银行(借记卡)
	// BankType                 = "SCNX_DEBIT"        // 四川农信(借记卡)
	// BankType                 = "BEEB_CREDIT"       // 鄞州银行(信用卡)
	// BankType                 = "SDRCU_DEBIT"       // 山东农信(借记卡)
	// BankType                 = "BCZ_DEBIT"         // 沧州银行(借记卡)
	// BankType                 = "SJB_DEBIT"         // 盛京银行(借记卡)
