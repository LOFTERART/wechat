...
func (c *Client) ReportMicropay(body ReportMicropayBody) (wxRsp ReportMicropayResponse, err error) {
	// 处理参数
	if body.InterfaceUrl, err = util.EscapedPath("https://api.mch.weixin.qq.com/pay/batchreport/micropay/total"); err != nil {
		return
	}
	body.TradesStr = util.MarshalJson(body.Trades)
	// 业务逻辑
